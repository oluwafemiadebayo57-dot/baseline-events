// app/halls/page.tsx
// Showcase page — both halls side by side with their real facilities and prices.
...
// Placeholder photos — swap for real ones later.
      ...
      {halls.map((hall, i) => (
        ...
        >
          <div className="mx-auto grid max-w-6xl gap-12 px-6 md:grid-cols-2 md:items-center">
            ...
            >
              <Image
                src={hall.image_url ?? FALLBACK_IMAGES[hall.slug] ?? FALLBACK_IMAGES["big-hall"]}
                alt={hall.name}
                fill
